...
using Ykx.Communication;
using Ykx.Communication.Modbus;
using Ykx.Industrial427.BLL;
using Ykx.Industrial427.Model;

namespace Ykx.Industrial427.Base
{
    public class GlobalMonitor
    {
        ...
        public static void Start(Action successAction, Action<string> faultAction)
        {
            mainTask = Task.Run(async() =>
            {
                ...
                {
                    faultAction("程序无法启动，串口初始化失败！请检查设备是否连接正常。");
                }
            });
        }
